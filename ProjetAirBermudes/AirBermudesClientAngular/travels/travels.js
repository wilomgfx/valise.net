angular.module('AppAirBermudes.travels', ['ui.bootstrap.datetimepicker'])
...
function TravelMinDetailsDirective($timeout, $location, MapService, DataService) {
    return {
        ...
        templateUrl: "travels/travelMinDetails.html",
...
function CreateTravelDirective() {
    ...
    return {
        ...
        restrict: "E",
        templateUrl: "travels/createTravel.html",
